...
class ChannelInfo:
  ...
  def __init__(self,
   chimney=None, connection=None,
   channelIndex=None, position=None,
   channel=None,
   ):
    if channel is not None:
      assert position is None and channelIndex is None
      position = ChannelInfo.positionOfChannel(channel)
      channelIndex = ChannelInfo.indexOfChannel(channel)
    # if
  ...
  def __init__(self,
   ...
   testName="",
    ...
    ChannelInfo.__init__(self, 
     ...
     channelIndex=channelIndex, position=position,
     )
    self.test         = testName
    self.index        = index
  # __init__()
